...
public static class WithBindingExtensions
{
    ...
    ///     Before, we stitched together the strings (via an interpolated string). The PropertyPath constructor will then just
    ///     unstitch them.
    ...
    /// </summary>
    private static string GetPath(int length)
    {
